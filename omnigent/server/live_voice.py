...
def session_config(*, instructions: str, model: str | None, voice: str | None) -> dict[str, Any]:
...
async def open_session(
    *,
    ...
    body = {
        ...
        "session": session_config(instructions=instructions, model=model, voice=voice),
    }
