"""measure_nexus.py <run dir>: brain Claude cost/tokens, Gemini worker tokens and weekly points, wall time to the brain's final answer."""
...
brain = {"output": 0, "cache_read": 0, "cache_write": 0, "usd": 0.0}; gem = {"tokens": 0, "calls": 0, "workers": 0}
...
row = {"minutes": round((end - start - paused) / 60, 1) if end else None, "paused_min": round(paused / 60, 1), "usd": round(brain["usd"], 2), "brain": brain, "gemini": gem,
