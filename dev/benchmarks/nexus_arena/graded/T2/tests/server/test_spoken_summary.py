...
"""
    ...
    # [fairness] the direct strip_markdown_for_speech check is dropped: where the block is removed
    # is a design choice; what the rewriter receives (below) is the behaviour.
